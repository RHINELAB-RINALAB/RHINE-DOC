...
\title{\textbf{Statement} \\ Laboratory Rulebook on Behaviours} % Full title of your tech report
...
\memoid{DOC-OR-06} % ID of the tech report
...
\begin{abstract}
    \noindent
    This document states of the \textbf{fundamental ruleset} for the usage of 
    \keywords{Policy, statement.}
\end{abstract}
...
This is the \textbf{verdict} decision document. No amount of information are to be provided. 
